...
const About: React.FC = () => {
  ...
  const fadeInUp = (id: string, delay: number = 0): React.CSSProperties => ({
    opacity: isVisible[id] ? 1 : 0,
    transform: isVisible[id] ? 'translateY(0)' : 'translateY(30px)',
    transition: `all 0.6s ease-out ${delay}s`
  });

  const scaleIn = (id: string, delay: number = 0): React.CSSProperties => ({
    opacity: isVisible[id] ? 1 : 0,
  ...
  const topRowMembers: TeamMember[] = [
    { 
      ...
      linkedin: "https://www.linkedin.com/in/kamran-jafar-493822195"
    },
    { 
      name: "Sameera Wajid", 
      role: "Co-founder and Partner",
      linkedin: "https://www.linkedin.com/in/sameera-wajid-95b4b4a"
    }
  ];
  ...
  const bottomRowMembers: TeamMember[] = [
    { 
      name: "Babbar Wajid", 
      role: "Co-founder",
      linkedin: "https://www.linkedin.com/in/babbar-wajid-bb93b19"
    },
    { 
      name: "Abbas Ali Iqbal", 
      role: "Co-founder",
      linkedin: "https://www.linkedin.com/in/abbas-ali-iqbal"
    }
  ];
            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  {/* Team Cards - 4 team members with balanced 2x2 layout */}
                  <div className="space-y-12">
                    {/* Top Row - 2 Co-founders and Partners */}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl w-full">
                        {topRowMembers.map((member, index) => (
                          <div
                            ...
                            className="backdrop-blur-md shadow-2xl border border-white/50 rounded-2xl p-8 text-center group hover:shadow-lg hover:border-gray-300 transition-all duration-300 transform hover:-translate-y-1"
                          >
                            <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl w-full">
                        {bottomRowMembers.map((member, index) => (
                          <div
                            ...
                            id={`team-${index + 2}`}
                            data-animate
                            style={fadeInUp(`team-${index + 2}`, (index + 2) * 0.1)}
                            className="backdrop-blur-md shadow-2xl border border-white/50 rounded-2xl p-8 text-center group hover:shadow-lg hover:border-gray-300 transition-all duration-300 transform hover:-translate-y-1"
                          >
                            <div className="mb-6">
                              <h3 className="text-xl font-bold text-white mb-2">{member.name}</h3>
